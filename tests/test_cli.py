...
from e2b_mcp.cli import cli, get_config_dir, load_servers_config, save_servers_config
...
class TestToolOperations:
    ...
    def test_tools_execute_with_params(self, mock_get_runner, runner, temp_config_dir):
        ...
        result = runner.invoke(cli, [
            "tools", "execute", "filesystem", "read_file",
    ...
    def test_tools_execute_with_individual_params(self, mock_get_runner, runner, temp_config_dir):
        ...
        result = runner.invoke(cli, [
            "tools", "execute", "filesystem", "write_file",
...
class TestQuickExecute:
    ...
    def test_quick_execute_basic(self, mock_runner_class, runner):
        ...
        mock_result = {
            "content": [
                {"type": "text", "text": "Quick execution result"}
            ]
        }
        ...
        result = runner.invoke(cli, [
            "quick", "python test.py", "test_tool"
        ])
    ...
    def test_quick_execute_with_env_and_params(self, mock_runner_class, runner):
        ...
        mock_runner.execute_tool.assert_called_once_with("temp_server", "create_file", expected_params)
...
class TestCLIIntegration:
    ...
    def test_cli_integration_basic(self, runner):
        ...
        result = runner.invoke(cli, [
            "quick", "python -c 'import json; print(json.dumps({\"jsonrpc\": \"2.0\", \"result\": {\"tools\": []}}))'",
            "test_tool", "--json"
        ])
